    ...
    <h2 className="fw-bold mb-4 text-center">About Me</h2>
        <div className="row">
          <div className="col-12">
            <p className="text-secondary mb-4" style={{ lineHeight: "1.8", textAlign: "justify" }}>
              I'm a third-year Computer Science student at Madras Institute of Technology, Anna University,
